...
std::string FuncBase::getRawName() const
{
    return _name;
}
...
FuncBase::iterator FuncBase::begin()
{
    return _blocks.begin();
}

FuncBase::iterator FuncBase::end()
{
    return _blocks.end();
}

FuncBase::const_iterator FuncBase::begin() const
{
    return _blocks.begin();
}

FuncBase::const_iterator FuncBase::end() const
{
    return _blocks.end();
}

FuncBase::const_iterator FuncBase::cbegin() const
{
    return _blocks.cbegin();
}

FuncBase::const_iterator FuncBase::cend() const
{
    return _blocks.cend();
}
...
BlockBase *FuncBase::getBlock(iterator pos) const
{
    return pos->get();
}
