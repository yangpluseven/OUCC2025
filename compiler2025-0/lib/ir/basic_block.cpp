...
InstBase *BlockBase::getInstruction(iterator pos) const
{
    return pos->get();
}
...
BlockBase::iterator BlockBase::begin()
{
    return _instructions.begin();
}

BlockBase::iterator BlockBase::end()
{
...
BlockBase::const_iterator BlockBase::end() const
{
    return _instructions.end();
}
