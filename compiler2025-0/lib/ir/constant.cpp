...
Number ConstantNumber::getValue() const
{
    return _value;
}

int ConstantNumber::intValue() const
{
    return _value.intValue();
}

float ConstantNumber::floatValue() const
{
...
std::string ConstantZero::getName() const
{
